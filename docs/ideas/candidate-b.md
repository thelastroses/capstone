...
Today they       only use Strava which shows where previous runners have run and popular local paths
which falls short because     Strava won't show you a specific running plan tailored to your abilites and the popular local paths don't always mean they are safe
