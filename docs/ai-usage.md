...
| 2026-09-22 | Copilot Auto | "For a solo developer building an artwork gallery where artists are able to input their artworks into a 3D and 2D gallery with its canvas information right next to it, over about 200 remaining hours, list eight options for [the decision]. Include at least two that are unfashionable. For each: one sentence on what it is best at, and one sentence on its most common failure mode. Do not recommend one." | I kept the 8 options that it gave me and some of the failure mode sentences it gave me because I like how it was worded. I felt it did a better job at wording it then when I did | I changed how all of it was formatted and rewrote a couple sentences and picked which would be the 3 top three for pruning | I verified by comparing it to the database I choose and to the ones that I saw while I was researching for what would be a good database for my project. I compared what I remember reading and what I saw to what the AI outputted. |